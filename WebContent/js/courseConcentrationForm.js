function editCourseConcentration(degree_id, degree_type, degree_name) {
	var add_form = document.createElement("form");
	add_form.setAttribute("method", "post");
	add_form.setAttribute("action", "course_concentration_form.jsp");

	add_form.setAttribute("target", "edit_course_concentration_iframe");
	...
	add_form.submit();
	document.getElementById("edit_course_category_iframe").setAttribute("style", "display:none");
	document.getElementById("edit_course_concentration_iframe").setAttribute("style", "display:block;");
}