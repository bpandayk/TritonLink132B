        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt = conn.prepareStatement(
                            "INSERT INTO Candidate(candidate_num, advisor) VALUES (?, ?)");
                        pstmt.setString(1, request.getParameter("student_num"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        pstmt = conn.prepareStatement(
                            "UPDATE Candidate SET candidate_num = ?, advisor = ? WHERE id = ?");
                        pstmt.setString(1, request.getParameter("student_num"));
                        pstmt.setString(2, request.getParameter("advisor"));
            ...
            <%            
                   ...
                   ResultSet rs = statement.executeQuery(
                           ...
                           "c.id AS cid, advisor FROM Student s, Graduate g, PhDStudent phd, Candidate c " +
                           "WHERE student_num = graduate_num AND graduate_num = phdstudent_num " +
                           "AND phdstudent_num = candidate_num ORDER BY student_num ASC");
            %>
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="candidate_entry_form.jsp" method="post">
                            ...
                            <td><input value="" name="advisor" size="10" required></td>
            ...
            %>
                    <tr>
                        <form action="candidate_entry_form.jsp" method="post">
                            ...
                            <input type="hidden" value="<%= rs.getInt("cid")%>" name="cid">
                            <input type="hidden" value="graduate" name="student_type">
                            <input type="hidden" value="phd" name="graduate_type">
                            <input type="hidden" value="candidate" name="candidate_type">
                            <td>
                            ...
                            <td>
                              <input value="<%= rs.getString("advisor") %>" name="advisor" size="10" required>
                            </td>
                            <td>
