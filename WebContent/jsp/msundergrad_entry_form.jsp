...
<body>
<h4>MS-Undergraduate Entry Form</h4>
        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt = conn.prepareStatement(
                                "INSERT INTO MSUndergraduate(msundergraduate_num, department) VALUES (?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        pstmt = conn.prepareStatement(
                                "UPDATE MSUndergraduate SET msundergraduate_num = ?, department = ? WHERE id = ?");

                        pstmt.setString(1, request.getParameter("student_num"));
                        pstmt.setString(2, request.getParameter("department"));
                        pstmt.setInt(3, Integer.parseInt(request.getParameter("msuid")));
                        rowCount = pstmt.executeUpdate();
            ...
            <%            
                   ...
                   ResultSet rs = statement.executeQuery(
                           ...
                           "residency, student_type, u.id AS uid, college, major, minor, msu.id AS msuid, " +
                           "department FROM Student s, Undergraduate u, MSUndergraduate msu " +
                           "WHERE student_num = undergraduate_num AND undergraduate_num = msundergraduate_num " +
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="msundergrad_entry_form.jsp" method="post">
            ...
            %>
                    <tr>
                        <form action="msundergrad_entry_form.jsp" method="post">
                            ...
                            <input type="hidden" value="<%= rs.getInt("msuid") %>" name="msuid">
                            <input type="hidden" value="undergraduate" name="student_type">
                            <td>
