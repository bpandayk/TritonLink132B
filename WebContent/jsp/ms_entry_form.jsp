        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt = conn.prepareStatement(
                            "INSERT INTO MSStudent(msstudent_num, advisor) VALUES (?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        pstmt = conn.prepareStatement(
                            "UPDATE MSStudent SET msstudent_num = ?, advisor = ? WHERE id = ?");

                        pstmt.setString(1, request.getParameter("student_num"));
                        pstmt.setString(2, request.getParameter("advisor").equals("") ? null : request.getParameter("advisor"));
                        pstmt.setInt(3, Integer.parseInt(request.getParameter("msid")));
                        rowCount = pstmt.executeUpdate();
            ...
            <%            
                   ...
                   ResultSet rs = statement.executeQuery(
                           ...
                           "ms.id AS msid, advisor FROM Student s, Graduate g, MSStudent ms " +
                           "WHERE student_num = graduate_num AND graduate_num = msstudent_num " +
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="ms_entry_form.jsp" method="post">
                            <input type="hidden" value="insert" name="action">
                            <input type="hidden" value="graduate" name="student_type">
                            <input type="hidden" value="ms" name="graduate_type">
            ...
            %>
                    <tr>
                        <form action="ms_entry_form.jsp" method="post">
                            ...
                            <input type="hidden" value="<%= rs.getInt("msid")%>" name="msid">
                            <input type="hidden" value="graduate" name="student_type">
                            <input type="hidden" value="ms" name="graduate_type">
                            <td>
