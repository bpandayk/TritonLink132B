...
<body>
    <h1>Weekly Meeting Entry Form</h1>
        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO WeeklyMeeting(section_id, meeting_type, start_datetime, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE WeeklyMeeting SET section_id = ?, meeting_type = ?, start_datetime = ?, " +
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="weekly_meeting_entry_form.jsp" method="post">
                        ...
                        <form action="weekly_meeting_entry_form.jsp" method="post">
                            ...
                            %>
                              <select name="meeting_type" required>
                                <option value="LECTURE" <%=meeting_type.equals("LECTURE") ? "selected" : "" %>>LECTURE</option>
                                <option value="DISCUSSION" <%=meeting_type.equals("DISCUSSION") ? "selected" : "" %>>DISCUSSION</option>
                                <option value="LAB" <%=meeting_type.equals("LAB") ? "selected" : "" %>>LAB</option>
                              </select>
                            </td>
                            <td>
