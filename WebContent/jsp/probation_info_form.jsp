...
<body>
    <h1>Probation Period Info Form</h1>
    <table>
        <tr>
            <td valign="top">
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO ProbationPeriod(student_num, start_date, " +
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE ProbationPeriod SET student_num = ?, " +
                            "start_date = ?, end_date = ?, reason = ? WHERE id = ?");
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM ProbationPeriod WHERE id = ?");
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="probation_info_form.jsp" method="post">
                            ...
                            <td><input value="" name="reason" size="30" required></td>
            ...
            <%
                    rs.close();
                    rs = statement.executeQuery("SELECT * FROM ProbationPeriod ORDER BY student_num ASC");
                    while ( rs.next() ) {
            %>
                    <tr>
                        <form action="probation_info_form.jsp" method="post">
                            ...
                            <td>
                                <input type="text" value="<%= rs.getString("reason") %>" 
                                    name="reason" size="30" required>
                            </td>
                            <td>
